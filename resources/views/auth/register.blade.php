...
@section('subtitle','Ingresa tus datos para')
@section('content')
        ...
        <div class="card bg-secondary shadow border-0">
          ...
          <div class="card-body px-lg-5 py-lg-5">
            <div class="text-center text-muted mb-4">
              <small>Ingresar tus datos para registrarte</small>
            </div>
            @if($errors->any())
            <div class="alert alert-danger" role="alert">
                <span>Error!!</span><strong>{{$errors->first()}}</strong>
            </div>
            @endif
            <form role="form" method="POST" action="{{ route('register') }}">
              ...
              <div class="form-group">
                <div class="input-group input-group-alternative mb-3">
                  ...
                  <input class="form-control" name="name" placeholder="Nombre" type="text" value="{{ old('name') }}" required autocomplete="name" autofocus>
                </div>
              </div>
              <div class="form-group">
                <div class="input-group input-group-alternative mb-3">
